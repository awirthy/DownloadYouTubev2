...
RUN wget -O /tmp/DownloadYouTubev2.tar.gz https://github.com/awirthy/DownloadYouTubev2/archive/refs/tags/v1.04.0.tar.gz
...
RUN echo "/opt/DownloadYouTubev2/DownloadYouTubev2-1.04.0/DownloadYouTubev2.sh" >> /etc/periodic/15min/DownloadYouTubev2
RUN chmod 755 /opt/DownloadYouTubev2/DownloadYouTubev2-1.04.0/DownloadYouTubev2.sh
